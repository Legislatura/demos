...
app.get('/citizen/me', restrict, function (req, res) {
  ...
  res.json(expose('id firstName lastName email gravatar() staff profilePictureUrl sawTutorial')(req.user));
});
...
app.get('/citizen/:id', restrict, function (req, res) {
  ...
  api.citizen.get(req.params.id, function (err, citizen) {
    ...
    res.json(expose('id fullName gravatar() profilePictureUrl sawTutorial')(citizen));
  });
});
