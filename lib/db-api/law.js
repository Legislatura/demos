...
exports.all = function all(fn) {
  ...
  Law
  .find({ deletedAt: null })
  .select('id lawId mediaTitle tag participants votes createdAt updatedAt closingAt publishedAt deletedAt status open closed links author authorUrl phaseTwo')
