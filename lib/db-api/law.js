...
exports.all = function all(fn) {
  ...
  var fields = 'id lawId mediaTitle summary source tag votes createdAt updatedAt closingAt ' +
    'publishedAt deletedAt status open closed links author authorUrl authorUrl authorPictureUrl ' +
    'party partyUrl backgroundColor fontColor picture scores participants';
...
exports.everything = function all(fn) {
  log('Looking for all laws.')

  var fields = 'id lawId mediaTitle summary source tag votes createdAt updatedAt closingAt ' +
    'publishedAt deletedAt status open closed links author authorUrl authorUrl authorPictureUrl ' +
    'party partyUrl backgroundColor fontColor picture scores participants nothings littles somewhats verys' +
    'scoreParticipants';
