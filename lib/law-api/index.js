...
app.get('/law/:id', function (req, res) {
  ...
  api.law.get(req.params.id, function (err, lawDoc) {
    ...
    var keys = [
      ...
      'scores scoreParticipants nothings littles somewhats verys phaseTwo intro winner',
      'phaseOne.id phaseOne.mediaTitle phaseOne.backgroundColor phaseOne.fontColor singular'
    ];
