...
app.get('/law/:id', function (req, res) {
  ...
  api.law.get(req.params.id, function (err, lawDoc) {
    ...
    var keys = [
      ...
      'phaseTwo intro winner phaseOne singular order'
    ];
...
app.get('/law-phase-two/:id', function (req, res) {
  ...
  api.law.get(req.params.id, function (err, lawDoc) {
    ...
    var keys = [
      ...
      'authorUrl authorPictureUrl open closed',
      'phaseOne.id phaseOne.backgroundColor phaseOne.fontColor phaseOne.mediaTitle phaseOne.party phaseOne.partyUrl',
    ];
