...
var BillProposalViewer = require('bill-proposal-viewer');
...
page('/law/:id', citizen.optional, laws.middleware, function(ctx, next) {
  function validUrl() {
  ...
  var id = ctx.homepage ? null : ctx.params.id;
  var viewer = new BillProposalViewer(id);

  viewer.appendTo('section.app-content');
